	...
	<body>
		...
		<div id="show-nivel" class="content scaffold-show" role="main">
			...
			<ol class="property-list nivel">
				...
				<g:if test="${nivelInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="nivel.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${nivelInstance}" field="descricao"/></span>
