...
<div class="fieldcontain ${hasErrors(bean: unidadeFederativaInstance, field: 'sigla', 'error')} required">
	<label for="sigla">
...
<div class="fieldcontain ${hasErrors(bean: unidadeFederativaInstance, field: 'nome', 'error')} required">
	<label for="nome">
